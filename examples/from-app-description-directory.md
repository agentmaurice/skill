...
Model the application as one or more deployments, each with one canonical Agent Spec.
...
2. Extract deployments, Agent Specs, conceptual slices, and runtime modes
